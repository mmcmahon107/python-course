...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print("\n\n*** Results Summary for CNN Model Architecture",model.upper(), 
          "***")
    print("{:20}: {:1d}".format('Nbr Images', results_stats_dic['n_images']))
    print("{:20}: {:1d}".format('Nbr Dog Images', results_stats_dic['n_dogs_img']))
    print("{:20}: {:1d}".format('Nbr Not-Dog Images', results_stats_dic['n_notdogs_img']))

    # Prints the summary statistics (percentages) on the Model Run
    print("\n*** Percentage Calculations ***")

    # Retrieve the keys and values if the key begins with 'p'.
